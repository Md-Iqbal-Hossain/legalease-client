...
// import { getLoggedInLawyerHirings } from '@/lib/api/hirings';
// import HiringHistoryTable from './HiringHistoryTable';

// export default async function LawyerHiringHistoryPage() {
//   const initialRequests = await getLoggedInLawyerHirings();
...
//           Review, accept, or reject legal consultation requests from potential clients.
//         </p>
//       </div>

//       <HiringHistoryTable initialRequests={initialRequests} />
//     </div>
//   );
// }
...
//       try {
//         const data = await getLoggedInLawyerHirings();
//         setRequests(data || []);
//       } catch (err) {
//         console.error("Hiring page fetch error:", err);
//       } finally {
//         setLoading(false);
//       }
//     }
...
//         <span className="animate-pulse">Loading Inbound Case Requests...</span>
//       </div>
//     );
//   }
...
//       <HiringHistoryTable initialRequests={requests} />
//     </div>
//   );
// }
...
// এই পেজটি এখন সম্পূর্ণ সার্ভার-সাইড, তাই কোনো 'use client' থাকবে না
export default async function LawyerHiringHistoryPage() {
  
  // এটি এখন একটি সুরক্ষিত সার্ভার অ্যাকশন হিসেবে ব্যাকএন্ডে রান হবে
  const initialRequests = await getLoggedInLawyerHirings();
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      {/* ইন্টারেক্টিভ পার্টটি হ্যান্ডেল করবে আমাদের ক্লায়েন্ট টেবিল */}
      <HiringHistoryTable initialRequests={initialRequests || []} />
    </div>
  );
}